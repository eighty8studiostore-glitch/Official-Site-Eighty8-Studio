 ...
 * Redesigned with professional enterprise chatbot UI
 */
...
const PRODUCT_ALIASES = {
  ...
  "gift card": "18x23 1/16", "flyer": "18x23 Letter(1/4)", "flysheet": "18x23 Letter(1/4)",
  "leaflet": "18x23 Letter(1/4)", "pamphlet": "18x23 Letter(1/4)", "handout": "18x23 Letter(1/4)",
  "handbill": "18x23 Letter(1/4)", "circular": "18x23 Letter(1/4)", "insert": "18x23 Letter(1/4)",
  "quarter page": "18x23 Letter(1/4)", "quarter sheet": "18x23 Letter(1/4)",
  "3 fold brochure": "18x23 1/6 Horizontal", "3fold brochure": "18x23 1/6 Horizontal",
  "three fold brochure": "18x23 1/6 Horizontal", "tri fold brochure": "18x23 1/6 Horizontal",
  "trifold brochure": "18x23 1/6 Horizontal", "tri-fold brochure": "18x23 1/6 Horizontal",
  "z fold brochure": "18x23 1/6 Horizontal", "z-fold brochure": "18x23 1/6 Horizontal",
  "c fold brochure": "18x23 1/6 Horizontal", "accordion brochure": "18x23 1/6 Horizontal",
  "letter fold brochure": "18x23 1/6 Horizontal", "4 fold brochure": "18x23 1/8",
  "four fold brochure": "18x23 1/8", "gate fold brochure": "18x23 1/8",
  "gatefold brochure": "18x23 1/8", "2 fold brochure": "18x23 Letter(1/4)",
  "bifold brochure": "18x23 Letter(1/4)", "bi fold brochure": "18x23 Letter(1/4)",
  "bi-fold brochure": "18x23 Letter(1/4)", "single fold brochure": "18x23 Letter(1/4)",
  "two fold brochure": "18x23 Letter(1/4)", "trifold": "18x23 1/6 Horizontal",
  "tri-fold": "18x23 1/6 Horizontal", "tri fold": "18x23 1/6 Horizontal",
  "3fold": "18x23 1/6 Horizontal", "z fold": "18x23 1/6 Horizontal",
  "z-fold": "18x23 1/6 Horizontal", "accordion fold": "18x23 1/6 Horizontal",
  "letter fold": "18x23 1/6 Horizontal", "c fold": "18x23 1/6 Horizontal",
  "gatefold": "18x23 1/8", "gate fold": "18x23 1/8", "gate-fold": "18x23 1/8",
  "bifold": "18x23 Letter(1/4)", "bi-fold": "18x23 Letter(1/4)", "bi fold": "18x23 Letter(1/4)",
  "brochure": "18x23 Letter(1/4)", "half sheet": "18x23 1/2", "half page": "18x23 1/2",
  "half size": "18x23 1/2", "tabloid": "18x23 1/2", "poster": "full",
  "full sheet": "full", "full size": "full", "broadsheet": "full",
  "a3": "18x25 A3", "a4": "18x25 A4", "a5": "18x25 A5", "legal": "legal",
  "letter": "18x23 Letter(1/4)", "restaurant menu": "18x25 A4", "menu": "18x25 A4",
  "greeting card": "18x23 1/8", "invitation card": "18x23 Letter(1/4)",
  "invitation": "18x23 Letter(1/4)", "invite": "18x23 Letter(1/4)",
  "wedding card": "18x23 1/8", "postcard": "18x23 1/8",
  "catalogue": "18x25 A4", "catalog": "18x25 A4", "magazine": "18x25 A4",
  "booklet": "18x25 A5", "newsletter": "18x23 Letter(1/4)", "notepad": "18x25 A5",
  "dl envelope": "18x23 1/12", "envelope": "18x23 1/8",
};
...
function ARModal({ onClose, onMeasurementComplete }) {
  ...
  return (
    ...
    >
      <div
        className="bg-[#13151C] border border-white/10 w-full sm:max-w-lg rounded-t-3xl sm:rounded-2xl overflow-hidden shadow-2xl max-h-[95dvh] overflow-y-auto"
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 pt-5 pb-4 border-b border-white/[0.06]">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center">
              <svg viewBox="0 0 20 20" fill="none" className="w-4.5 h-4.5 text-indigo-400" width="18" height="18">
                <path d="M3 7V4a1 1 0 011-1h3M17 7V4a1 1 0 00-1-1h-3M3 13v3a1 1 0 001 1h3M17 13v3a1 1 0 01-1 1h-3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
          ...
          <button
            onClick={onClose}
            className="w-8 h-8 flex items-center justify-center rounded-full bg-white/5 hover:bg-white/10 text-slate-400 hover:text-white text-xs transition-all"
          >
        ...
        <ARMeasureTool
          onMeasurementComplete={(dims) => { onMeasurementComplete(dims); onClose(); }}
          onClose={onClose}
        />
      </div>
    </div>
      ...
      <div style={{ minHeight: "100vh", background: "var(--bg)", fontFamily: "var(--sans)" }}>
        ...
        <div style={{ maxWidth: 740, margin: "0 auto", padding: "32px 24px 64px", display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div style={{ padding: "14px 18px", borderBottom: "1px solid var(--border)", display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <div style={{ width: 30, height: 30, borderRadius: "50%", background: "linear-gradient(135deg,#6366F1,#3B82F6)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                <svg viewBox="0 0 20 20" fill="none" width="14" height="14">
                  <circle cx="10" cy="7" r="3" stroke="#fff" strokeWidth="1.5" />
                  <path d="M7 7h-.5a2 2 0 00-2 2v.5M13 7h.5a2 2 0 012 2v.5" stroke="#fff" strokeWidth="1.5" strokeLinecap="round" />
                  <rect x="5" y="12" width="10" height="5" rx="2" stroke="#fff" strokeWidth="1.5" />
                  <circle cx="8" cy="14.5" r=".75" fill="#fff" />
                  <circle cx="12" cy="14.5" r=".75" fill="#fff" />
                </svg>
              </div>
              <div style={{ flex: 1 }}>
            ...
            <div style={{ padding: "16px 18px 18px" }}>
              ...
              <div style={{ position: "relative" }}>
                <textarea
                  ...
                  style={{
                    ...
                    border: "1px solid var(--border2)", borderRadius: 12, fontSize: 13.5,
                    color: "var(--text)", resize: "none", outline: "none", transition: "border-color .15s, box-shadow .15s",
                    fontFamily: "var(--sans)", lineHeight: 1.6,
                  }}
                  placeholder={"e.g. \"10,000 trifold brochures on 130gsm\""}
                  value={prompt}
                ...
                />
                {/* Character hint */}
                <span style={{ position: "absolute", bottom: 10, right: 12, fontSize: 11, color: "var(--muted)", pointerEvents: "none" }}>
                  {prompt.length > 0 ? `${prompt.length} chars` : "Type your job"}
                </span>
              </div>
              ...
              {detectedInfo.alias && (
                <div className="fade-up" style={{ marginTop: 10, display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
                  <span style={{ fontSize: 11, fontWeight: 600, padding: "3px 10px", borderRadius: 20, background: "rgba(34,197,94,.1)", color: "#4ADE80", border: "1px solid rgba(34,197,94,.2)" }}>
                    ✓ Detected: "{detectedInfo.alias}"
                  </span>
                  <svg viewBox="0 0 16 16" fill="none" width="10" height="10" style={{ color: "var(--muted)" }}>
                    <path d="M3 8h10M9 4l4 4-4 4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                  <span style={{ fontSize: 11, fontWeight: 600, padding: "3px 10px", borderRadius: 20, background: "rgba(59,130,246,.1)", color: "#60A5FA", border: "1px solid rgba(59,130,246,.2)" }}>
                    {formData.jobSize}
                  </span>
                </div>
              )}
              {parseWarning && (
                <div className="fade-up" style={{ marginTop: 10, display: "flex", gap: 7, alignItems: "flex-start", padding: "9px 12px", borderRadius: 9, background: "rgba(245,158,11,.07)", border: "1px solid rgba(245,158,11,.2)" }}>
                  <svg viewBox="0 0 16 16" fill="none" width="13" height="13" style={{ color: "#F59E0B", marginTop: 1, flexShrink: 0 }}>
                    <path d="M8 1L1 14h14L8 1zm0 4v5M8 12v.5" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
                  </svg>
          ...
          <form
            ...
            className="fade-up"
            style={{ background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 16, overflow: "hidden", animationDelay: ".05s" }}
          >
            {/* Form header */}
            <div style={{ padding: "14px 20px", borderBottom: "1px solid var(--border)", display: "flex", alignItems: "center", gap: 9 }}>
              <svg viewBox="0 0 20 20" fill="none" width="15" height="15" style={{ color: "var(--muted)" }}>
            ...
            <div style={{ padding: "20px 20px", display: "flex", flexDirection: "column", gap: 20 }}>
              ...
              {/* Row 1 — Preset + Sheet Sizes */}
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(180px,1fr))", gap: 14 }}>

                {/* Preset selector column */}
                <div>
                  <FieldLabel icon={
                    <svg viewBox="0 0 16 16" fill="none" width="12" height="12"><rect x="2" y="2" width="12" height="12" rx="2" stroke="currentColor" strokeWidth="1.3" /><path d="M5 8h6M8 5v6" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" /></svg>
                  }>Product / Job Size</FieldLabel>
                  ...
                  <select
                    ...
                    required
                    style={{
                      marginTop: 6, width: "100%", padding: "9px 36px 9px 12px",
                      background: "var(--surface2)", border: "1px solid var(--border2)", borderRadius: 9,
                      fontSize: 13, color: formData.jobSize ? "var(--text)" : "var(--muted)", outline: "none",
                  ...
                  >
                    ...
                    {Object.entries(JOB_SIZE_PRESETS).map(([key, val]) => (
                      <option key={key} value={key}>{val.label}</option>
                    ))}
                  </select>

                  {preset && (
                    <p style={{ fontSize: 11, color: "var(--muted)", marginTop: 5, fontFamily: "var(--mono)" }}>
                      Piece: {preset.dims} in
                    </p>
                  )}
                  ...
                  <button
                    ...
                    style={{
                      ...
                      color: "#A5B4FC", transition: "all .15s", letterSpacing: ".01em",
                    }}
                    onMouseEnter={e => { e.currentTarget.style.background = "rgba(99,102,241,.14)"; e.currentTarget.style.borderColor = "rgba(99,102,241,.35)"; }}
                    onMouseLeave={e => { e.currentTarget.style.background = "rgba(99,102,241,.08)"; e.currentTarget.style.borderColor = "rgba(99,102,241,.2)"; }}
                  >
                  ...
                  {arMeasured && (
                    <div className="fade-up" style={{
                      marginTop: 8, padding: "9px 12px", borderRadius: 9, fontSize: 12,
                      background: arMeasured.exact ? "rgba(34,197,94,.06)" : "rgba(245,158,11,.06)",
                      border: `1px solid ${arMeasured.exact ? "rgba(34,197,94,.2)" : "rgba(245,158,11,.2)"}`,
                      color: arMeasured.exact ? "#4ADE80" : "#FCD34D",
                    }}>
                      <div style={{ fontWeight: 600, marginBottom: 3, fontFamily: "var(--mono)", fontSize: 11 }}>
                        {arMeasured.exact ? "✓" : "~"} AR: {arMeasured.width}" × {arMeasured.height}"
                      </div>
                      {arMeasured.matchLabel && (
                        <p style={{ fontSize: 10.5, opacity: .75, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>→ {arMeasured.matchLabel}</p>
                      )}
                      <button
                        type="button"
                        onClick={() => { setArMeasured(null); setShowARModal(true); }}
                        style={{ marginTop: 4, fontSize: 10.5, opacity: .6, textDecoration: "underline", background: "none", border: "none", cursor: "pointer", color: "inherit", padding: 0 }}
                      >
                        Re-measure
                      </button>
                    </div>
                ...
                <div>
                  <FieldLabel icon={
                    <svg viewBox="0 0 16 16" fill="none" width="12" height="12"><rect x="3" y="2" width="10" height="12" rx="1.5" stroke="currentColor" strokeWidth="1.3" /></svg>
                  }>Print Sheet</FieldLabel>
                  <input
                    type="text" readOnly value={formData.printSheetSize} placeholder="Auto-detected"
                    style={{
                      marginTop: 6, width: "100%", padding: "9px 12px",
                      background: "rgba(255,255,255,.03)", border: "1px solid var(--border)", borderRadius: 9,
                      fontSize: 13, color: "var(--muted)", fontFamily: "var(--mono)", outline: "none",
                    }}
                  />
                </div>
                ...
                <div>
                  <FieldLabel icon={
                    <svg viewBox="0 0 16 16" fill="none" width="12" height="12"><rect x="2" y="2" width="12" height="12" rx="1.5" stroke="#60A5FA" strokeWidth="1.3" /><path d="M5 8h6M8 5v6" stroke="#60A5FA" strokeWidth="1.3" strokeLinecap="round" /></svg>
                  } accent>Full Sheet <span style={{ fontWeight: 400, color: "var(--muted)", fontSize: 10.5 }}>(weight basis)</span></FieldLabel>
                  <input
                    type="text" readOnly value={formData.fullSheetSize} placeholder="Auto-detected" required
                    style={{
                      marginTop: 6, width: "100%", padding: "9px 12px",
                      background: "rgba(59,130,246,.06)", border: "1px solid rgba(59,130,246,.25)", borderRadius: 9,
                      fontSize: 13, fontWeight: 700, color: "#93C5FD", fontFamily: "var(--mono)", outline: "none",
                    }}
                  />
                </div>
              </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(140px,1fr))", gap: 14 }}>
                <div>
                  <FieldLabel icon={
                    <svg viewBox="0 0 16 16" fill="none" width="12" height="12"><path d="M3 4h10M3 8h6M3 12h8" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" /></svg>
                  }>Total Copies</FieldLabel>
                  <StyledNumInput value={formData.jobCopies} onChange={set("jobCopies")} placeholder="e.g. 10000" min={1} required />
                </div>
                <div>
                  <FieldLabel icon={
                    <svg viewBox="0 0 16 16" fill="none" width="12" height="12"><circle cx="8" cy="8" r="5" stroke="currentColor" strokeWidth="1.3" /><path d="M8 5v3l2 2" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" /></svg>
                  }>Paper GSM</FieldLabel>
                ...
                <div>
                  ...
                  }>UPS <span style={{ fontWeight: 400, color: "var(--muted)", fontSize: 10.5 }}>(per full sheet)</span></FieldLabel>
              ...
              <div>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }}>
                  <FieldLabel icon={
                    <svg viewBox="0 0 16 16" fill="none" width="12" height="12"><path d="M2 14L14 2M6 14h8v-8" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" /></svg>
                  }>Waste / Spoilage</FieldLabel>
                  <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    ...
                    <span style={{
                      ...
                      background: formData.wastePercent === 0 ? "rgba(34,197,94,.1)" : formData.wastePercent <= 5 ? "rgba(59,130,246,.1)" : formData.wastePercent <= 10 ? "rgba(245,158,11,.1)" : "rgba(239,68,68,.1)",
                      color: formData.wastePercent === 0 ? "#4ADE80" : formData.wastePercent <= 5 ? "#60A5FA" : formData.wastePercent <= 10 ? "#FCD34D" : "#F87171",
                    }}>
                      {formData.wastePercent === 0 ? "None" : formData.wastePercent <= 5 ? "Standard" : formData.wastePercent <= 10 ? "Moderate" : "High"}
                    </span>
                  </div>
                </div>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <div style={{
                    ...
                    width: `${(formData.wastePercent / 20) * 100}%`, pointerEvents: "none", zIndex: 1,
                  }} />
                  <input
                    type="range" min="0" max="20" step="1"
                    style={{ width: "100%", position: "relative", zIndex: 2 }}
                    value={formData.wastePercent}
                    onChange={(e) => setFormData(prev => ({ ...prev, wastePercent: parseInt(e.target.value, 10) }))}
                  />
                </div>

                <div style={{ display: "flex", justifyContent: "space-between", marginTop: 5 }}>
                  {["0%", "5%", "10%", "15%", "20%"].map(v => (
                    <span key={v} style={{ fontSize: 10, color: "var(--muted)", fontFamily: "var(--mono)" }}>{v}</span>
                  ))}
                </div>
              </div>
              ...
              <button
                ...
                disabled={loading}
                style={{
                  width: "100%", padding: "12px 20px", borderRadius: 10, border: "none", cursor: loading ? "not-allowed" : "pointer",
                  background: loading ? "rgba(59,130,246,.3)" : "linear-gradient(135deg, #2563EB, #3B82F6)",
                  color: "#fff", fontSize: 14, fontWeight: 700, letterSpacing: ".02em",
                  boxShadow: loading ? "none" : "0 1px 20px rgba(59,130,246,.35)",
                  transition: "all .2s", display: "flex", alignItems: "center", justifyContent: "center", gap: 8,
                  opacity: loading ? .7 : 1,
                }}
                onMouseEnter={e => { if (!loading) { e.currentTarget.style.background = "linear-gradient(135deg,#1D4ED8,#2563EB)"; e.currentTarget.style.transform = "translateY(-1px)"; e.currentTarget.style.boxShadow = "0 4px 24px rgba(59,130,246,.45)"; } }}
                onMouseLeave={e => { if (!loading) { e.currentTarget.style.background = "linear-gradient(135deg,#2563EB,#3B82F6)"; e.currentTarget.style.transform = ""; e.currentTarget.style.boxShadow = "0 1px 20px rgba(59,130,246,.35)"; } }}
              >
                {loading ? (
                  <>
                  ...
                  <>
                    <svg viewBox="0 0 20 20" fill="none" width="15" height="15">
                      <path d="M4 10h12M11 5l5 5-5 5" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
            ...
            <section className="fade-up" style={{ background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 16, overflow: "hidden" }}>
              ...
              <div style={{ padding: 20, display: "flex", flexDirection: "column", gap: 16 }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 8 }}>
                  {[
                    { label: "Per sheet", value: `${(results.weightPerSheet * 1000).toFixed(2)} g` },
                    { label: "Per ream", value: `${results.weightPerReam} kg` },
                    { label: "Net reams", value: results.netReams.toFixed(2) },
                  ].map(({ label, value }) => (
  ...
  return (
    <input
      ...
      style={{
        marginTop: 6, width: "100%", padding: "9px 12px",
        background: "var(--surface2)", border: "1px solid var(--border2)", borderRadius: 9,
        fontSize: 13, color: "var(--text)", fontFamily: "var(--mono)", outline: "none",
