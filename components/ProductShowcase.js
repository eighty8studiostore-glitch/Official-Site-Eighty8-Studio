      ...
      <div className="max-w-7xl mx-auto relative z-0">
        <div className="flex flex-col lg:flex-row items-stretch">
          ...
          <div className="flex-1 lg:pr-16 py-8 flex flex-col justify-center">
            ...
            {/* CTA Button */}
            <div>
              <a href="/oneclick" className="group flex items-center gap-3 px-8 py-4 bg-zinc-900 text-white font-bold rounded-xl hover:bg-black transition-all shadow-lg shadow-black/5 hover:shadow-xl hover:translate-y-[-2px]">
                Book Your Demo Now 
